<?php
// TODO 
// check btc/doge rate again if error
// put $ in wallet in ~ USD
// add graphs for temp & speed 
// BE DONE
...
define('SCRIPT_URL', 'http://webserverIP');

// Time in Seconds to Auto Refresh the script
define('SCRIPT_REFRESH', 20000);
...
// E-Mail for Alerts
define('ALERT_EMAIL', 'email@email.com');
